    ...
    <section className="side-nav">
      <nav>
        ...
        >
          <ul>
            <li>
              <Link onClick={() => { openNav(); handleHamb(); }} to="/">
                Home
              </Link>
            </li>
            <li>
              <Link onClick={() => { openNav(); handleHamb(); }} to="/about">
                About
              </Link>
            </li>
            <li>
              <Link onClick={() => { openNav(); handleHamb(); }} to="/projects">
                Projects
              </Link>
            </li>
            <li>
              <Link onClick={() => { openNav(); handleHamb(); }} to="/service">
                Service
              </Link>
            </li>
            <li>
              <Link onClick={() => { openNav(); handleHamb(); }} to="/contact">
                Contact
              </Link>
            </li>
          </ul>
        ...
        {/* mobile nav hamburger button */}
        <div className="mobile-hamb" onClick={() => { openNav(); handleHamb(); }}>
          <i className={`${hambButton ? "fa-regular fa-x fa-xl" : "fa-solid fa-bars fa-xl"}`}></i>
        </div>
      </nav>
    </section>
